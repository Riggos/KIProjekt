...
class Random_Forrest_class:
    ...
    def get_potential_splits(self, data, random_subspace):  # Input is a numpy 2D arry
        ...
        if random_subspace:
            # pick random features for the subtrees
    ...
    def random_forrest_predictions(self, test_df, forest):
        ...
        # return the prediction that appears the most
